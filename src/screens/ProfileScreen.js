    ...
    <View style={{height, width}}>
      ...
      <View style={styles.summary}>
        <View
          ...
          <View style={{width: width * 0.7, alignSelf:'center', flexDirection:'row', justifyContent:'space-between'}}>
          ...
          <View style={{width: width * 0.9, padding: 10, alignSelf:'center',backgroundColor:'#232', flexDirection:'row', justifyContent:'space-between'}}>
